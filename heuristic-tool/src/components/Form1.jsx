...
const Form1 = (props) => {
  ...
  const [questions] = useState([
    {
      question:
        "Are product descriptions clear and detailed with high-quality images?",
      options: ["Yes", "Room for improvement", "No", "Not Applicable"],
      scores: [2, 1, 0, -1],
      qCat: "Navigation",
    },
    {
      question: "Do you always know where you are on the site?",
      options: ["Yes", "Room for improvement", "No", "Not Applicable"],
      scores: [2, 1, 0, -1],
      qCat: "Navigation",
    },
    ...
    {
      question: "Does the hierarchy of categories/pages make sense to you?",
      options: ["Yes", "Room for improvement", "No", "Not Applicable"],
      scores: [2, 1, 0, -1],
      qCat: "Navigation",
    },
    ...
    {
      question: "Is the search box visible wherever you are on the site?",
      options: ["Yes", "Room for improvement", "No", "Not Applicable"],
      scores: [2, 1, 0, -1],
      qCat: "Search",
    },
    {
      question:
        "Is the website easy to navigate and find what you are looking for?",
      options: ["Yes", "Room for improvement", "No", "Not Applicable"],
      scores: [2, 1, 0, -1],
      qCat: "Search",
    },
    ...
    {
      question: "Are advanced search features available?",
      options: ["Yes", "Room for improvement", "No", "Not Applicable"],
      scores: [2, 1, 0, -1],
      qCat: "Search",
    },
    ...
    {
      question:
        "Does the website provide clear and concise information about its products and services? ",
      options: ["Yes", "Room for improvement", "No", "Not Applicable"],
      scores: [2, 1, 0, -1],
      qCat: "mainquestions",
    },
    {
      question:
        "Are the website's forms and checkout processes easy to use and understand?",
      options: ["Yes", "Room for improvement", "No", "Not Applicable"],
      scores: [2, 1, 0, -1],
      qCat: "mainquestions",
    },
    {
      question: "Are customer reviews and ratings visible and accessible?",
      options: ["Yes", "Room for improvement", "No", "Not Applicable"],
      scores: [2, 1, 0, -1],
      qCat: "mainquestions",
    },
    {
      question:
        "Is the shopping cart easily accessible and clearly shows items added?",
      options: ["Yes", "Room for improvement", "No", "Not Applicable"],
      scores: [2, 1, 0, -1],
      qCat: "mainquestions",
    },
    {
      question:
        "Does the website provide ways for users to contact customer support if they have questions or issues?",
      options: ["Yes", "Room for improvement", "No", "Not Applicable"],
      scores: [2, 1, 0, -1],
      qCat: "mainquestions",
    },
  ...
  return (
    <>
      ...
      <div className="tab-container">
          {qCatValues.map((qCat, index) => (
            <div
              className={`tab ${currentQuestion === index ? "active" : ""}`}
              onClick={() => handleTabClick(qCat)}
              key={qCat}
            >
              {qCat}
            </div>
      ...
      <div className="quiz-container col-md-auto ">
        <form method="POST" onSubmit={handleNext} style={{width: "90%"}}>
          <br />
          <h4>{questions[currentQuestion].qCat}</h4>
          <hr></hr>
          <br />
